...
- [ ] Inicializar o frontend web React da Eduka-Angola
- [ ] Definir a experiência e o design da página index pública inspirada na Udemy
- [ ] Implementar a página index pública em React
- [ ] Aplicar identidade Eduka-Angola e modos claro e escuro à index web
...
- [x] Alinhar a página de notícias com os padrões de hero, cartões e acções da Edukangola
- [x] Simplificar o destaque, a pesquisa e os filtros de artigos e vídeos
- [ ] Validar a página de notícias em desktop e mobile

- [x] Inventariar capas disponíveis e associá-las às notícias existentes
- [x] Aplicar capas aos artigos e vídeos do Telejornal sem imagem
- [x] Validar capa no destaque e nos cartões da página de notícias

- [x] Substituir o título da página de notícias por “O que importa para o seu futuro.”
- [x] Validar o novo título no hero de notícias

- [x] Documentar a estrutura actual e a divisão entre frontend React e backend Django

- [x] Adicionar bloco de notícias da semana à página de notícias
- [x] Adicionar temas/tags navegáveis para descoberta de conteúdo
- [x] Mostrar conteúdos relacionados no detalhe da notícia
...
- [ ] Migrar certificados de cursos em vídeo, assinatura e analytics para o GestorEduka React
