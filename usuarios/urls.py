...
urlpatterns = [
    ...
    path('api/react/aluno/formador/teste/', views.api_react_formador_teste, name='api_react_formador_teste'),
    path('api/react/aluno/formador/enviar-codigo/', views.api_react_formador_enviar_codigo, name='api_react_formador_enviar_codigo'),
    path('api/react/aluno/formador/candidatar/', views.api_react_formador_candidatar, name='api_react_formador_candidatar'),
    ...
    path('api/react/admin/recuperar-senha/', views.api_auth_admin_recuperar_senha, name='api_auth_admin_recuperar_senha'),
    path('api/react/admin/redefinir-senha/', views.api_auth_admin_redefinir_senha, name='api_auth_admin_redefinir_senha'),
    path('api/react/admin/criar-conta/', views.api_auth_admin_bootstrap, name='api_auth_admin_bootstrap'),
