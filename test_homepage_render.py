...
if gestor is not None:
    ...
    authenticated_html = b''.join(authenticated_response.streaming_content).decode('utf-8') if authenticated_response.streaming else authenticated_response.content.decode('utf-8')
