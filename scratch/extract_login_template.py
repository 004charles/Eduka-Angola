...
def unpack_bundle(file_path):
    ...
    with open('scratch/extracted_login.html', 'w', encoding='utf-8') as f:
        f.write(final_html)

    print("Desempacotamento concluído com sucesso! Salvo em scratch/extracted_login.html")

if __name__ == "__main__":
    unpack_bundle(r"C:\Users\Muquissi\Downloads\edukangola-login.html")
