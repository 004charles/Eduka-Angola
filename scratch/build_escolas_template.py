...
<body class="rbt-header-sticky">
    ...
    <main class="rbt-main-wrapper" style="padding-bottom: 60px;">
        ...
        <div class="drawing-header-hero" style="background: #ffffff; border-bottom: 1px solid #e6e3f1; padding: 34px 40px 30px">
            <div class="container" style="max-width: 1400px;">
                ...
                <form action="{% url 'escolas:lista_escolas' %}" method="GET" class="drawing-search-box" style="display: flex; align-items: stretch; height: 52px; border: 1.5px solid #192335; border-radius: 11px; background: #ffffff; overflow: hidden; max-width: 800px">
                    <input type="text" name="q" value="{{ q }}" placeholder="Procurar escola, liceu ou instituto médio…" style="flex: 1; border: none; outline: none; background: transparent; font-size: 15px; color: #0f172a; padding: 0 18px">
        ...
        <div class="container" style="max-width: 1400px; margin-top: 26px;">
        ...
        <div class="container" style="max-width: 1400px; margin-top: 28px;" id="escolas-grid">
            <div class="drawing-escolas-layout" style="display: grid; grid-template-columns: 264px 1fr; gap: 28px; align-items: start">
                    ...
                    <form action="{% url 'escolas:lista_escolas' %}" method="GET">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px; font-size: 13.5px; padding-bottom: 20px; border-bottom: 1px solid #e6e3f1">
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="nivel" value="Primário" {% if nivel_selecionado == 'Primário' %}checked{% endif %} onchange="this.form.submit()"> Primário
                            </label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="nivel" value="I ciclo" {% if nivel_selecionado == 'I ciclo' %}checked{% endif %} onchange="this.form.submit()"> I Ciclo
                            </label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="nivel" value="II ciclo" {% if nivel_selecionado == 'II ciclo' %}checked{% endif %} onchange="this.form.submit()"> II Ciclo / Liceu
                            </label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="nivel" value="Médio técnico" {% if nivel_selecionado == 'Médio técnico' %}checked{% endif %} onchange="this.form.submit()"> Médio Técnico
                            </label>
                        </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px; font-size: 13.5px; padding-bottom: 20px; border-bottom: 1px solid #e6e3f1">
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="natureza" value="Pública" {% if natureza_selecionada == 'Pública' %}checked{% endif %} onchange="this.form.submit()"> Pública
                            </label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="natureza" value="Privada" {% if natureza_selecionada == 'Privada' %}checked{% endif %} onchange="this.form.submit()"> Privada
                            </label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;">
                                <input type="checkbox" name="natureza" value="Comparticipada" {% if natureza_selecionada == 'Comparticipada' %}checked{% endif %} onchange="this.form.submit()"> Comparticipada
                            </label>
                        </div>
                        ...
                        <div class="drawing-heading-title" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; font-size: 12.5px; color: #192335; margin: 20px 0 12px">Outros Benefícios</div>
                        <div style="display: flex; flex-direction: column; gap: 10px; font-size: 13.5px">
                            ...
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;"><input type="checkbox"> Transporte escolar</label>
                            <label style="display: flex; align-items: center; gap: 9px; cursor: pointer; color: #192335;"><input type="checkbox"> Cantina escolar</label>
                        </div>
                    </form>
                </div>
...
"""
    with open('escolas/templates/escolas/lista_escolas.html', 'w', encoding='utf-8') as out:
        out.write(template)
    print("Successfully built escolas/templates/escolas/lista_escolas.html!")
