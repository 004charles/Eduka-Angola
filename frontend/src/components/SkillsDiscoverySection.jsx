      ...
      <div className="page-width">
        <div className="skills-discovery-heading">
          <div>
            ...
            <h2 id="skills-discovery-title">Encontre a próxima competência para desenvolver.</h2>
            <p>Escolha uma área e explore cursos publicados por centros, com preços e informação clara antes de decidir.</p>
          </div>
          <a className="text-action" href={destinoCatalogo}>Ver catálogo <ArrowRight size={16} /></a>
        </div>
        ...
        <div id="competencia-painel" role="tabpanel" aria-labelledby={temaAtivo === "todos" ? "competencia-todos" : `competencia-${temaAtivo}`} className="skills-courses-panel">
          <div className="skills-courses-head">
            <p>{temaAtivo === "todos" ? "Cursos publicados com condições de inscrição visíveis." : `Cursos publicados em ${temaAtivo}.`}</p>
