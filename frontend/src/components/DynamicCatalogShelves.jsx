...
function construirColecoes(data, incluirCatalogo = true) {
  ...
  adicionarColecao({ id: "video-cursos", eyebrow: "Cursos em vídeo Edukangola", title: "Aprenda ao seu ritmo, com compra única.", description: "Cursos em vídeo produzidos pela Edukangola, com aulas gravadas e acesso após compra ou acesso gratuito.", courses: videos, featured: true, autoAdvance: videos.length > 1 });
