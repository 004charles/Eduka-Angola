...
export default function MarketplaceShelf({ products = [], onNavigate }) {
  ...
  return <section className="marketplace-shelf" aria-label="Mercado Edukangola">
    <div className="page-width marketplace-shelf-heading">
      <div>
    ...
    <div className="page-width marketplace-shelf-footnote"><MapPin size={14} /> Entregas disponíveis em Luanda</div>
  </section>;
}
