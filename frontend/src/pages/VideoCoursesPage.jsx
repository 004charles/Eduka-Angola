...
function formatAccess(course) {
  return course.pagamento?.agora ? `Plano mensal · ${course.pagamento.agora}` : "Subscrição mensal";
}
    ...
    <main className="video-page">
      <header className="video-page-hero">
        <div className="page-width video-page-hero-inner">
          ...
          <p>Uma subscrição mensal da Edukangola dá-lhe acesso a todo o catálogo de cursos em vídeo, para estudar e retomar ao seu ritmo.</p>
      ...
      <section className="video-library-section" id="programas-video">
        <div className="page-width">
          <div className="video-library-heading"><div><span className="eyebrow muted">Biblioteca incluída na subscrição</span><h2>Encontre um curso para começar agora.</h2></div><p>{courses.length} {courses.length === 1 ? "curso publicado" : "cursos publicados"}</p></div>
